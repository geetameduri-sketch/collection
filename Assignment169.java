package collection;
//Write a program to demonstrate the following functions like append, insert, replace, delete, reverse, capacity, charAt, length, substring(int) & substring (start & end index) 
//using StringBuffer concept
public class Assignment169 {
public static void main(String[] args) 
{
	StringBuffer sb= new StringBuffer("Rudra");
	StringBuffer sb1 = sb.append("Prasad @");
	System.out.println("After Append: " + sb1);
	StringBuffer sb2 = sb.insert(13, 2007);
	System.out.println("Inserting the index value: "+sb2);
	StringBuffer sb3 = sb.replace(0, 11, "Rudra ");
	...
	StringBuffer sb5 = sb.delete(6, 7);
